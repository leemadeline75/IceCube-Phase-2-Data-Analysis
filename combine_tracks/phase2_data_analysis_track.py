...
###########################
    ...
    'pred_skim': 'SKIMMING',
    'pred_tgtrack': 'TRACK',
    'pred_starttrack': 'TRACK',
    'pred_stoptrack': 'TRACK',
    'pred_cascade': 'CASCADE'
}

    result_consensus['idx_max_score'] = result_consensus['idx_max_score'].map(DNN_mapping)
...
# Define the categories explicitly to ensure order consistency
    ...
    result_consensus['ntn_category'] = pd.Categorical(
