...
class Reducer:
    ...
    def reduce(self):
        ...
        for id in subj_ids:
            subj_dict[id] = {'THROUGHGOINGTRACK': 0, 'STOPPINGTRACK': 0, 'STARTINGTRACK': 0, 'CASCADE': 0, 'SKIMMING': 0}  #initialize dict key to subj id, value to 0
    ...
    #accounts for three types: cascade, skimming, track and three subtypes of tracks: starting, stopping, and through-going ML
        ...
        #df.replace({'data.most_likely':['Through-Going Track', 'Stopping Track', 'Starting Track', 'Skimming Track', 'Cascade']}, {'data.most_likely':['through-going-track', 'stopping-track', 'starting-track', 'skimming-track', 'cascade']})  #not working ML
